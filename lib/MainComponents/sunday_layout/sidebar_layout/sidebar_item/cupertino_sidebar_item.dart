...
class SundayCupertinoSidebarItem extends StatefulWidget {
  /// Creates a [SundayCupertinoSidebarItem].
  ///
  /// The [onTap], [icon], [text], [keyIndex], [itemTextColor], [darkItemTextColor], and [selectedIndex] parameters
  /// must not be null.
  const SundayCupertinoSidebarItem({
    super.key,
    required this.onTap,
    required this.icon,
    required this.text,
  ...
  @override
  State<SundayCupertinoSidebarItem> createState() => _SidebarItemState();
}

/// State class for [SidebarItem].
class _SidebarItemState extends State<SundayCupertinoSidebarItem> {
  @override
