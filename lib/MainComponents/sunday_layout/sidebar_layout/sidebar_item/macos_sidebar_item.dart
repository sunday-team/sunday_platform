...
class SundayMacOSSidebarItem extends StatefulWidget {
  /// Creates a [SundayMacOSSidebarItem].
  ///
  ...
  @override
  State<SundayMacOSSidebarItem> createState() => _SundayMacOSSidebarItemState();
}

/// State class for [SidebarItem].
class _SundayMacOSSidebarItemState extends State<SundayMacOSSidebarItem> {
  @override
